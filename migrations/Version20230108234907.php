 ...
 */
final class Version20230108234907 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tenant_invite ADD tenant_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\'');
